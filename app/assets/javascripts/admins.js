  ...
  return {
    ...
    init: function() {
      ...
      function saveRow(oTable, nRow, id) {
        ...
        if (jqInputs[0].value) data['admin[number]'] = jqInputs[0].value;
        if (jqInputs[1].value) data['admin[name]'] = jqInputs[1].value;
        if (jqInputs[2].value) data['admin[password]'] = jqInputs[2].value;
        if (jqInputs[3].value) data['admin[role]'] = jqInputs[3].value;
        $.ajax({
          url: url,
          data: data,
          type: type,
